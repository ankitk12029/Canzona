...
if ($conn->connect_error) {
  ...
  if ( isset($_POST["user_name"]) && !empty($_POST["user_name"]) && isset($_POST["password"]) && !empty($_POST["password"]) && isset($_POST["fname"]) && !empty($_POST["fname"]) && isset($_POST["lname"]) && !empty($_POST["lname"]) 
    && isset($_POST["email_id"]) && !empty($_POST["email_id"]) && isset($_POST["gender"]) && !empty($_POST["gender"]) ) {
